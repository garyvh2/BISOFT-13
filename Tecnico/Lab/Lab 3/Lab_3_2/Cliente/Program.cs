...
namespace Cliente
{
    class Program
    {
                        ...
                        do
                        {
                            ...
                            if (Int32.TryParse(Console.ReadLine(), out operacion))
                            {
                                switch (operacion)
                                {
                                    ...
                                    case 2:
                                        // Eliminar
                                        DialogResult dialogResult = MessageBox.Show("Todos los registros de produccion para este animal seran aliminados", "Eliminacion recursiva", MessageBoxButtons.YesNo);
        ...
        private static void ObtenerDatosAnimal(ref Animal animal, Boolean update = false)
        {
            ...
            } while (!(animal.Categoria is string));
            // Alimento
            do
            {
            ...
            } while (!(animal.Alimento is string));
            // Edad
            selected = false;
            do
            {
        ...
        private static void ObtenerDatosProduccion(ref Produccion produccion, Boolean update = false)
        {
            ...
            } while (!(produccion.Tipo is string));
        ...
        {
            // Row
            return animal.Id + ". " + animal.Nombre + " / " + animal.Categoria + " (" + animal.FechaNac + ")";
        }
    }
}
