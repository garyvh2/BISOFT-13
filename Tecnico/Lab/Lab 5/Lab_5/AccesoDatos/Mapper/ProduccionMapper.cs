...
namespace AccesoDatos.Mapper
{
    public class ProduccionMapper : EntityMapper, ISqlStaments, IObjectMapper
    {
        ...
        private const string DB_COL_ID_TIPO_PRODUCCION   = "ID_TIPO_PRODUCCION";
        ...
        public SqlOperation GetCreateStatement(BaseEntity entity)
        {
            ...
            operation.AddIntParam(DB_COL_ID_TIPO_PRODUCCION, c.IdTipoProduccion);
        ...
        public BaseEntity BuildObject(Dictionary<string, object> row)
        {
            var produccion = new Produccion
            {
                ...
                IdTipoProduccion= GetIntValue       (row, DB_COL_ID_TIPO_PRODUCCION),
